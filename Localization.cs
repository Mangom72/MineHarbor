...
internal static partial class Launcher
{
	...
	internal static class Localization
	{
		...
		private static readonly Dictionary<string, string> KoreanTexts = new Dictionary<string, string>
		{
			...
			{ "Tooltip.Operations", "모든 서버의 알림과 검증된 운영 기록을 확인합니다." },
			...
			{ "Close.IdleQuestion", "MineHarbor를 종료하시겠습니까?" },
			{ "Close.WorkQuestion", "현재 작업이 진행 중입니다. 작업이 끝난 뒤 MineHarbor를 종료하시겠습니까?" },
			{ "Close.ServerQuestion", "Minecraft 서버가 실행 중입니다. 월드를 안전하게 저장하고 서버를 종료한 뒤 MineHarbor를 닫으시겠습니까?" },
			{ "Close.Title", "MineHarbor 종료" },
			...
			{ "Setup.Owner", "서버 소유자" },
			{ "Setup.DuplicationTitle", "바닐라 장치 호환성 · 비지원 기능" },
			{ "Setup.PistonDuplication", "TNT·양탄자·레일 복사 허용" },
			{ "Setup.GravityDuplication", "모래 등 중력 블록 복사 허용" },
			{ "Setup.TripwireDuplication", "철사덫 갈고리 복사 허용" },
			{ "Setup.DuplicationStatus", "복사 동작 설정 지원 상태" },
			{ "Setup.DuplicationSupported", "{0}에 안전하게 저장됩니다. 서버를 다시 시작하면 적용됩니다." },
			{ "Setup.DuplicationPartiallySupported", "{0}에 저장됩니다. 이 서버 버전은 활성화된 항목만 지원합니다." },
			{ "Setup.DuplicationUnavailable", "이 서버는 Paper 전용 복사 설정을 사용하지 않습니다. Spigot·Vanilla는 기본 동작을 따릅니다." },
			{ "Setup.DuplicationCustomUnavailable", "Paper 계열 직접 JAR은 한 번 실행해 설정 파일을 만든 뒤 사용할 수 있습니다." },
			{ "Setup.DuplicationRiskHint", "Paper가 공식 지원하지 않는 호환 설정이며 서버 업데이트로 동작이 바뀔 수 있습니다." },
			{ "Setup.DuplicationWarningTitle", "비지원 복사 동작 허용" },
			{ "Setup.DuplicationWarning", "선택한 복사 동작은 Paper/Purpur가 공식 지원하지 않는 설정입니다. 서버 안정성이나 플러그인 동작에 영향을 줄 수 있으며, 서버 버전에 따라 작동하지 않을 수 있습니다. 그래도 허용하시겠습니까?" },
			{ "Setup.Cancel", "다음에" },
			{ "Setup.CancelEdit", "취소" },
			{ "Setup.Save", "이대로 저장" },
		...
		private static readonly Dictionary<string, string> EnglishTexts = new Dictionary<string, string>
		{
			...
			{ "Tooltip.Operations", "Review notifications and verified operations for every server." },
			...
			{ "Eula.Title", "Minecraft EULA" },
			{ "Close.IdleQuestion", "Close MineHarbor?" },
			{ "Close.WorkQuestion", "A task is still running. Close MineHarbor after the task finishes?" },
			{ "Close.ServerQuestion", "A Minecraft server is running. Save the world, stop the server safely, and then close MineHarbor?" },
			{ "Close.Title", "Close MineHarbor" },
			...
			{ "Setup.DuplicationTitle", "Vanilla mechanics compatibility · Unsupported" },
			{ "Setup.PistonDuplication", "Allow TNT, carpet, and rail duplication" },
			{ "Setup.GravityDuplication", "Allow gravity block duplication" },
			{ "Setup.TripwireDuplication", "Allow tripwire hook duplication" },
			{ "Setup.DuplicationStatus", "Duplication compatibility status" },
			{ "Setup.DuplicationSupported", "Saved safely to {0}. Restart the server to apply it." },
			{ "Setup.DuplicationPartiallySupported", "Saved to {0}. This server version supports only the enabled controls." },
			{ "Setup.DuplicationUnavailable", "This server does not use Paper-only duplication settings. Spigot and Vanilla keep their default behavior." },
			{ "Setup.DuplicationCustomUnavailable", "Run a Paper-family custom JAR once to create its configuration before using these options." },
			{ "Setup.DuplicationRiskHint", "This Paper compatibility setting is unsupported and may change after a server update." },
			{ "Setup.DuplicationWarningTitle", "Allow unsupported duplication" },
			{ "Setup.DuplicationWarning", "These duplication mechanics are unsupported Paper/Purpur settings. They can affect server stability or plugins and may not work on every version. Allow them anyway?" },
			{ "Setup.Cancel", "Later" },
