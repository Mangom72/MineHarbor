...
& $javac '--release' '8' '-Xlint:-options' '-encoding' 'UTF-8' '-d' $classes $protocol $test
if ($LASTEXITCODE -ne 0) { throw 'Bridge protocol test compilation failed.' }
& $java '-cp' $classes 'io.github.mcserverlauncher.bridge.BridgeProtocolTest'
